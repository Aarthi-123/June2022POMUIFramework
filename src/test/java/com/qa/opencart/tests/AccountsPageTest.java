...
public class AccountsPageTest extends BaseTest {
	...
	@Description("accPageTitleTest -- Dev Name: @Aarthi")
	...
	@Description("accPageUrlTest -- Dev Name: @Aarthi")
	...
	@Description("Acc page search test -- Dev Name: @Aarthi")
	...
	@Description("Acc page logout link exist test -- Dev Name: @Aarthi")
	@Severity(SeverityLevel.CRITICAL)
	@Test(priority = 4)
	...
	@Description("Acc page header test -- Dev Name: @Aarthi")
	...
	@Description("Acc page search check test -- Dev Name: @Aarthi")
	@Severity(SeverityLevel.CRITICAL)
	...
	@Description("Acc page product search test -- Dev Name: @Aarthi")
...
///*************************************Assignment**************************************/
//DataProvider using Excel sheet:
	
//	@DataProvider
//	public Object[][] getProdTestData() {
//		Object prodData[][] = ExcelUtil.getTestData(AppConstants.PRODUCT_SHEET_NAME);
//		return prodData;
//	}
//	
//	@Test(dataProvider = "getProdTestData", priority = 7)
//	public void searchTest(String searchKey, String mainProductName) {
//		searchResultsPage = accPage.performSearch(searchKey);
//		if(searchResultsPage.isSearchSuccessful()) {
//			productInfoPage = searchResultsPage.selectProduct(mainProductName);
